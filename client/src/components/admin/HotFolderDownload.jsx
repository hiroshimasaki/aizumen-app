                ...
                <div className="flex flex-col lg:flex-row gap-8 items-center relative z-10">
                    <div className="flex-1 space-y-4 text-center lg:text-left">
                        ...
                        <div className="flex flex-wrap gap-4 justify-center lg:justify-start pt-2">
                            <a
                                href="https://github.com/hiroshimasaki/aizumen-app/releases/download/v1.2.4/AiZumen-HotFolder-Setup-1.2.4.exe"
                            ...
                            <a
                                href="https://github.com/hiroshimasaki/aizumen-app/releases/download/v1.2.4/AiZumen-HotFolder-1.2.4.exe"
